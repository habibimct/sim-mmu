<div
    x-data="attendanceEditModal()"
    x-on:open-attendance-edit.window="openModal($event.detail.id)"
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <p
                                ...
                                x-text="attendance.organization_name"
                            ></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="mt-1 font-medium text-gray-800"
                                x-text="attendance.subject_name"
                            ></p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                type="number"
                                min="1"
                                x-model="attendance.meeting_number"
                                class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                            >
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mb-3 flex items-center justify-between">
                            ...
                            <span
                                ...
                                x-text="attendance.students.length + ' siswa'"
                            ></span>
                        </div>
                            ...
                            <div class="max-h-[50vh] overflow-y-auto">
                                ...
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        ...
                                        <template
                                            x-for="(student, index) in attendance.students"
                                            :key="student.id"
                                        >
                    ...
                    const response = await fetch(
                        `{{ url('/guru/attendance') }}/${this.attendanceId}`,
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                meeting_number:
                                    this.attendance.meeting_number,

                                notes:
                                    this.attendance.notes,

                                students:
                                    this.attendance.students.map(
                                        student => ({
