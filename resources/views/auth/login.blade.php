            ...
            <div
               ...
               p-10 xl:p-14">
                       ...
                       xl:text-lg">
                        ...
                        <div class="flex mt-3 items-center gap-4 text-sm text-white/75">
                ...
                <div class="bg-white px-5 py-6 sm:px-8 sm:py-8 lg:px-12 lg:py-12">
                    ...
                    <div class="mb-4 flex items-center gap-3 lg:hidden">
                        ...
                        <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-600 shadow-md">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="relative mt-2">
                                ...
                                <x-text-input id="email" name="email" type="text" :value="old('email')" required
                                    autofocus autocomplete="username" placeholder="nama@email.com"
                                    class="block w-full rounded-xl border-slate-300 py-3 pl-10 text-sm shadow-sm transition focus:border-blue-500 focus:ring-blue-500" />
                        ...
                        <button type="submit"
                            class="mt-4 flex w-full items-center justify-center rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition duration-200 hover:bg-blue-700 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 active:scale-[0.99]">
                    ...
                    <p class="mt-5 text-center text-xs text-slate-400 lg:hidden">
                        &copy; {{ date('Y') }} PMUB.
