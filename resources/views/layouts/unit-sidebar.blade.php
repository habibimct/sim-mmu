<div x-data="{
    ...
    <div class="h-16 px-5 border-b border-white/20 flex items-center">
    ...
    <nav class="flex-1 px-3 pb-4 overflow-y-auto">
        ...
        <a href="{{ route('kepala-unit.dashboard') }}"
            class="group flex items-center gap-3
                   ...
                   {{ request()->routeIs('kepala-unit.dashboard')
        ...
        <a href="{{ route('kepala-unit.notifications.index') }}"
            class="group flex items-center justify-between
                   ...
                   rounded-xl
                   transition-all duration-200
                   {{ request()->routeIs('kepala-unit.notifications.*')
                       ? 'bg-white/20 text-white shadow-lg ring-1 ring-white/20'
                       : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
        ...
        <button type="button" @click="openFinance = !openFinance"
            ...
            <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180': openFinance }" fill="none"
        ...
        {{-- Submenu Keuangan --}}
        <div x-show="openFinance" x-collapse
           ...
           {{ request()->routeIs('kepala-unit.finance.transactions.*')
            ...
            <a href="{{ route('kepala-unit.finance.summary.index') }}"
                ...
                text-xs
                transition
                {{ request()->routeIs('kepala-unit.finance.summary.*')
                    ? 'bg-white/15 text-white'
                    : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
                <span
                    class="w-1.5 h-1.5 rounded-full
                    {{ request()->routeIs('kepala-unit.finance.summary.*') ? 'bg-white' : 'bg-white/40' }}"></span>
        ...
        <button type="button" @click="openOrganization = !openOrganization"
            ...
            <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180': openOrganization }"
        ...
        {{-- Submenu Organisasi --}}
        <div x-show="openOrganization" x-collapse
            class="mt-1 ml-5 pl-7
                   border-l border-white/20
                   space-y-1">
        ...
        <button type="button" @click="openReports = !openReports"
            ...
            <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180': openReports }"
                fill="none" stroke="currentColor" viewBox="0 0 24 24">
